        ...
        <div class="col-sm-10 offset-sm-2" id="main">
          <nav class="col-lg-4 navbar nav-tabs mt-xl-0" id="nav3">
            <ul class="nav nav-pills d-inline-flex ml-auto col-sm-12">
              ...
              <li class="nav-item"><a class="nav-link edit-active" href="vendors_and_staffs_profile_delete.php">Delete</a></li>
            </ul>
          </nav>
          <div class="col-sm-8 offset-sm-4 edit-form">
          <h2 class="mb-4 ml-4 pl-4 offset-sm-2">Delete Staffs Profile</h2>
            <form action="functions/deleteStaffProfileProcessor.php" class="needs-validation mr-4 pr-4 ml-4 pl-4 mb-4 pb-4 col-sm-10 offset-sm-1" novalidate method="post">
