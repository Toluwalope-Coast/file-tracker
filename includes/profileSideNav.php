<nav class="col-sm-2 sidebar"> <!-- side bar nav -->
            <ul class="nav flex-column flex-wrap navbar-dark position-fixed pt-2 col-sm-2" id="sidebar">
                <li class="nav-item">
                    <i class='fas fa-home fa-fw' aria-hidden="true"></i><a href="dashboard.php" class="nav-link"> Dashboard <i class="fas fa-caret-left fa-fw fa-2x col-sm-12" aria-hidden="true"></i></a>
                </li>
                <li class="nav-item">
                    <i class='fas fa-comment-alt fa-fw' aria-hidden="true"></i><a href="messages.php" class="nav-link"> Messages <i class="fas fa-caret-left fa-fw fa-2x col-sm-12 offset-sm-1" aria-hidden="true"></i></a>
                </li>
                <li class="nav-item" id="file">
                    <i class='fas fa-file fa-fw' aria-hidden="true"></i><a class="nav-link"  href="file.php"> File <i class="fas fa-caret-left fa-fw fa-2x col-sm-12 offset-sm-4" aria-hidden="true"></i></a>
                ...
                <li class="nav-item" id="report">
                    <i class="fa fa-list fa-fw" aria-hidden="true"></i><a class="nav-link" href="reports.php"> Reports <i class="fas fa-caret-left fa-fw fa-2x col-sm-12 offset-sm-2" aria-hidden="true"></i></a>
                    <ul  class="dropdown-list flex-column">
                ...
                <li class="nav-item active" id="profile">
                    <i class='fas fa-user fa-fw' aria-hidden="true"></i><a class="nav-link" href="profile.php"> Profile <i class="fas fa-caret-left fa-fw fa-2x col-sm-12 offset-sm-2" aria-hidden="true"></i></a>
                    <ul class="dropdown-list flex-column">
